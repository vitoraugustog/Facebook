	...
	public class ErroLogin {
		...
		public void testeLogin() throws InterruptedException {
		  ...
		  driver.findElement(By.id("email")).sendKeys("vitorqaa@outlook.com");
		  Assert.assertEquals("vitorqaa@outlook.com", driver.findElement(By.id("email")).getAttribute("value"));
		  Thread.sleep(600);
