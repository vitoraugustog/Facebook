	...
	public class ErroSenha {
		...
		public void testeLogin() throws InterruptedException {
		  ...
		  driver.findElement(By.id("pass")).sendKeys("teste1233_");
		  Assert.assertEquals("teste1233_", driver.findElement(By.id("pass")).getAttribute("value"));
		  Thread.sleep(600);
